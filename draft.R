...
ggplot(data = finalharmdata,aes(x = finalharmdata$SelfHarm14,y = finalharmdata$`Metropolitan/Micropolitan Statistical Area`))+geom_boxplot()

modselfharm14 = lm(`Metropolitan/Micropolitan Statistical Area`~ SelfHarm14,data = finalharmdata)
t.test(SelfHarm14 ~ `Metropolitan/Micropolitan Statistical Area`,data = finalharmdata)
